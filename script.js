...
const EuropeQuestions = [
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["estoniaflag.jpg", "latviaflag.jpg", "luxemburgflag.jpg", "lithuaniaflag.jpg"], ["Estonie", "Lettonie", "Luxembourg", "Lithuanie"], {"dropEstonie" : "Estonie", "dropLettonie" : "Lettonie", "dropLuxembourg" : "Luxembourg", "dropLithuanie" : "Lithuanie"}),
  new ImageInput("Dans quel pays est situé le contenu de l'image ci-dessous?", "france", "Le Mont Saint-Michel est situé en France.", "mont-saint-michel.jpg"),
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["norwayflag.jpg", "icelandflag.jpg", "denmarkflag.jpg", "finlandflag.jpg"], ["Norvège", "Islande", "Danemark", "Finlande"], {"dropNorvège" : "Norvège", "dropIslande" : "Islande", "dropDanemark" : "Danemark", "dropFinlande" : "Finlande"}),
  new ImageInput("Dans quel pays est situé le contenu de l'image ci-dessous?", "allemagne", "La Porte de Brandebourg est situé en Allemagne.", "brandenburg-gate.jpg")
]; 
const AfricaQuestions = [
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["kenyaflag.jpg", "mozambiqueflag.jpg", "zimbabweflag.jpg", "angolaflag.jpg"], ["Kenya", "Mozambique", "Zimbabwe", "Angola"], {"dropKenya" : "Kenya", "dropMozambique" : "Mozambique", "dropZimbabwe" : "Zimbabwe", "dropAngola" : "Angola"}),
  new ImageInput("Dans quel pays se trouve cette fameuse montagne d'Afrique?", "tanzanie", "Le mont Kilimanjaro est situé en Tanzanie.", "kilimanjaro.jpg"),
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["sudanflag.jpg", "ghanaflag.jpg", "libyaflag.jpg", "mauritaniaflag.jpg"], ["Soudan","Ghana", "Libye", "Mauritanie"], {"dropSoudan" : "Soudan", "dropGhana" : "Ghana", "dropLibye" : "Libye", "dropMauritanie" : "Mauritanie"}),
  new ImageInput("Dans quel pays d'Afrique se trouve le site dans cette image?", "tunisie", "Il s'agit des ruines d'un collisée romain à El Djem en Tunisie.", "el-djem.jpg")
];
const AsiaQuestions = [
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["iraqflag.jpg", "uaeflag.jpg", "syriaflag.jpg", "koweitflag.jpg"], ["Irak", "Émirats Arabes Unis", "Syrie", "Koweit"], {"dropIrak" : "Irak", "dropÉmirats Arabes Unis" : "Émirats Arabes Unis", "dropSyrie" : "Syrie", "dropKoweit" : "Koweit"}),
  new ImageInput("Dans quel pays se trouve le site dans cette image?", "jordanie", "La cité de Petra est en Jordanie.", "petra.jpg"),
  ...
  new DragDropQuestion("Placez les drapeaux à côté du bon pays.", ["cambodiaflag.jpg", "thailandflag.jpg", "burmaflag.jpg", "laosflag.jpg"], ["Cambodge", "Thailande", "Birmanie", "Laos"], {"dropCambodge" : "Cambodge", "dropThailande" : "Thailande", "dropBirmanie" : "Birmanie", "dropLaos" : "Laos"}),
  new ImageInput("Dans quel pays d'Asie se trouve le site dans cette image?", "inde", "Le Hawa Mahal se trouve en Inde.", "hawa-mahal.jpg")
];
...
const Images = {
  ...
  "Rhin" : "rhine.jpg",
  "Seine" : "seine.jpg",
  "Belgique" : "belgium.jpg",
  "Espagne" : "spain.jpg",
  "Portugal" : "portugal.jpg",
  "Danemark" : "denmark.jpg",
  "Macédoine" : "macedonia.jpg",
  "Moldavie" : "moldova.jpg",
  "Slovénie" : "slovenia.jpg",
  "Bosnie" : "bosnia.jpg",
  "Djibouti" : "djibouti.jpg",
  "Chad" : "chad.jpg",
  "Mali" : "mali.jpg",
  "Mauritanie" : "mauritania.jpg",
  "Algiers" : "algiers.jpg",
  "Tunis" : "tunis.jpg",
  "Benghazi" : "benghazi.jpg",
  "Marrakech" : "marrakech.jpg",
  "Nigeria" : "nigeria.jpg",
  "Égypte" : "egypt.jpg",
  "Éthiopie" : "ethiopia.jpg",
  "RD du Congo" : "drc.jpg",
  "Nile" : "nile.jpg",
  "Niger" : "niger.jpg",
  "Congo" : "congo.jpg",
  ...
  "Arménie" : "armenia.jpg",
  "Turquie" : "turkey.jpg",
  "Khazakstan" : "khazakstan.jpg",
  "Indus" : "indus.jpg",
  "Ganges" : "ganges.jpg",
  "Yangtze" : "yangtze.jpg",
  "Fleuve Jaune" : "yellow-river.jpg",
  "Muscat" : "muscat.jpg",
  "Alep" : "aleppo.jpg",
  "Dubai" : "dubai.jpg",
  "Dhaka" : "dhaka.jpg",
  "Indonésie" : "indonesia.jpg",
  "Japon" : "japan.jpg",
  "Philippines" : "philippines.jpg",
  "Corée du Sud" : "korea.jpg"
}
